...
public class WatchDAO {
    ...
    public void generateWatches() {
        ...
        add(new Watch("Model 1", ANALOGUE, new BigDecimal("100.00"), 10, vendor1));
        add(new Watch("Model 2", DIGITAL, new BigDecimal("200.00"), 10, vendor1));

        add(new Watch("Model 3", ANALOGUE, new BigDecimal("100.00"), 10, vendor2));
        add(new Watch("Model 4", DIGITAL, new BigDecimal("200.00"), 10, vendor2));

        add(new Watch("Model 5", ANALOGUE, new BigDecimal("100.00"), 10, vendor3));
